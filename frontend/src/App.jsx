...
const MODEL_URL = import.meta.env.BASE_URL + 'assets/industrial machine 3d model_Clone1.glb'
  ...
  return (
    <div className="app">
      ...
      <header className="navbar">
        <img src={import.meta.env.BASE_URL + 'assets/neemus black logo.png'} alt="Neemus" className="nav-logo" />
        <nav className="nav-links">
          <a href="#specs"   className="nav-link">SPECS</a>
          <a href={import.meta.env.BASE_URL + 'gallery'} className="nav-link">GALLERY</a>
      ...
      <footer className="site-footer" id="contact">
        <div className="footer-top">
          ...
          <img src={import.meta.env.BASE_URL + 'assets/neemus-eagle.png'} alt="" className="footer-eagle-img" aria-hidden="true" />
        </div>
